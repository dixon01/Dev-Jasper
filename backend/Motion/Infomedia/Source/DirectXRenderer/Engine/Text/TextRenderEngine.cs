...
namespace Gorba.Motion.Infomedia.DirectXRenderer.Engine.Text
{
    ...
    public class TextRenderEngine
        : RenderEngineBase<TextItem, ITextRenderEngine<IDxDeviceRenderContext>, TextRenderManager<IDxDeviceRenderContext>>,
          ITextRenderEngine<IDxDeviceRenderContext>
    {
        ...
        /// The manager.
        /// </param>
        public TextRenderEngine(TextRenderManager<IDxDeviceRenderContext> manager)
            : base(manager)
        {
        }
        ...
        protected override void DoRender(double alpha, IDxDeviceRenderContext context)
        {
            ...
            {
                this.oldSprite = new TextSprite(this.Manager, context);
            }

            if (this.newSprite == null)
            {
                this.newSprite = new TextSprite(this.Manager, context);
            }
