// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GreaterThanEvaluatorTest.cs" company="Gorba AG">
//   Copyright © 2011-2014 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the GreaterThanEvaluatorTest type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Motion.Infomedia.Core.Tests.Presentation.Evaluation
{
    ...
    /// <summary>
    /// Test for <see cref="GreaterThanEvaluator"/>.
    /// </summary>
    [TestClass]
    public class GreaterThanEvaluatorTest
    {
        ...
        public void StaticEvalTrueTest()
        {
            ...
            var eval = new GreaterThanEval
                           {
                               Left = new DynamicProperty(new ConstantEval("111")),
                               Right = new DynamicProperty(new ConstantEval("22"))
                           };

            var target = EvaluatorFactory.CreateEvaluator(eval, context) as GreaterThanEvaluator;
