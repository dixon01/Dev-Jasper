// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrEvaluatorTest.cs" company="Gorba AG">
//   Copyright © 2011-2014 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the OrEvaluatorTest type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Motion.Infomedia.Core.Tests.Presentation.Evaluation
{
    ...
    public class OrEvaluatorTest
    {
        ...
        /// <summary>
        /// Tests with an empty <see cref="OrEval"/>.
        /// </summary>
        [TestMethod]
        public void EmptyEvalTest()
        {
            ...
            var target = EvaluatorFactory.CreateEvaluator(eval, context) as OrEvaluator;
