// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NotEqualsEvaluatorTest.cs" company="Gorba AG">
...
namespace Gorba.Motion.Infomedia.Core.Tests.Presentation.Evaluation
{
    ...
    /// <summary>
    /// Test for <see cref="NotEqualsEvaluator"/>.
    /// </summary>
    [TestClass]
    public class NotEqualsEvaluatorTest
    {
        /// <summary>
        ...
        public void StaticEvalTrueTest()
        {
            ...
            var eval = new NotEqualsEval
            {
                Left = new DynamicProperty(new ConstantEval("A")),
                Right = new DynamicProperty(new ConstantEval("B"))
            };

            var target = EvaluatorFactory.CreateEvaluator(eval, context) as NotEqualsEvaluator;
        ...
        /// <summary>
        /// Tests with a static evaluation that returns true with two case sensitively unequal strings.
        /// </summary>
        [TestMethod]
        public void StaticEvalTrueCaseSensitiveTest()
        {
            var context = new PresentationContextMock();
