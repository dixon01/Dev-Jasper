// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LessThanOrEquaEvaluatorTest.cs" company="Gorba AG">
//   Copyright © 2011-2014 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the LessThanOrEquaEvaluatorTest type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Motion.Infomedia.Core.Tests.Presentation.Evaluation
{
    ...
    /// <summary>
    /// Test for <see cref="LessThanOrEqualEvaluator"/>.
    /// </summary>
    [TestClass]
    public class LessThanOrEquaEvaluatorTest
    {
        /// <summary>
        ...
        public void StaticEvalTrueTest()
        {
            ...
            var eval = new LessThanOrEqualEval
                           {
                               Left = new DynamicProperty(new ConstantEval("22")),
                               Right = new DynamicProperty(new ConstantEval("111"))
                           };

            var target = EvaluatorFactory.CreateEvaluator(eval, context) as LessThanOrEqualEvaluator;
