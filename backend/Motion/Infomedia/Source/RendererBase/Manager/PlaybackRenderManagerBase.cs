// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PlaybackRenderManagerBase.cs" company="Gorba AG">
//   Copyright © 2011-2014 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the PlaybackRenderManagerBase type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Motion.Infomedia.RendererBase.Manager
{
    ...
    /// </typeparam>
    public partial class PlaybackRenderManagerBase<TItem, TContext, TEngine>
    {
        /// <summary>
        ...
        public override int SortIndex
        {
            get
            {
                return this.Item.Id; // TODO: do we need to sort it properly?
            }
        }
    }
}