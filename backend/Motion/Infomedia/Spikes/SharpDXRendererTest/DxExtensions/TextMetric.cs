...
namespace Gorba.Motion.Infomedia.SharpDXRendererTest.DxExtensions
{
    ...
    public sealed class TextMetric
    {
        ...
        public FontPitchAndFamily PitchAndFamily
        {
            get
            {
                return (FontPitchAndFamily)this.metric.PitchAndFamily;
            }
        ...
        /// </summary>
        public FontCharacterSet CharSet
        {
            get
            {
                return (FontCharacterSet)this.metric.CharSet;
            }
        ...
        {
            // TODO: verify if this still works with SharpDX or how we can get the TextMetrics
            var textMetric = new TextMetric();

            var ptr = font.NativePointer;
            ...
            if (!func(ptr, ref textMetric.metric))
            {
                return null;
            }
