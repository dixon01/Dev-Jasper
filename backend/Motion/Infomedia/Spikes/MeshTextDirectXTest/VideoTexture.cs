    ...
    public class VideoTexture : ISampleGrabberCB, IDisposable
    {
        ...
        public void Start()
        {
            if (this.playbackState == PlaybackState.Stopped)
            {
                ...
                this.ManualEventWatcher(); // Watches for graph events on a seperate thread, and calls HandleGraphEvents() when triggered.
        ...
        private void TimerBasedEventPolling()
        {
            ...
            this.eventTimer.Elapsed += new System.Timers.ElapsedEventHandler(this.eventTimer_Elapsed);
