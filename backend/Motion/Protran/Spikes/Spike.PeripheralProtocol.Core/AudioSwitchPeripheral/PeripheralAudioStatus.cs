// --------------------------------------------------------------------------------------------------------------------
// <copyright company="Luminator Technology Group" file="PeripheralAudioStatus.cs">
...
*/
    ...
    public class PeripheralAudioStatus : IPeripheralAudioStatus
    {
        ...
        {
            this.Header = new PeripheralHeaderAudioSwitch(PeripheralAudioSwitchMessageType.AudioStatusResponse, Size);
        ...
        public const int Size = PeripheralHeaderAudioSwitch.HeaderSize + 13;
