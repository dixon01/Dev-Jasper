...
namespace Luminator.PeripheralProtocol.Core.Interfaces
{
    ...
    public interface IPeripheralHandler<TMessageType> : IDisposable
    {
        ...
        PeripheralContext<TMessageType> PeripheralContext { get; set; }
        ...
        IPeripheralBaseMessageType<TMessageType> ProcessReceivedMessages(PeripheralState<TMessageType> peripheralState, object message);
        ...
        T Read<T>(Stream stream = null, int readTimeout = 0) where T : class, IPeripheralBaseMessageType<TMessageType>;
        ...
        int Write<T>(T model) where T : IPeripheralBaseMessageType<TMessageType>;

        /// <summary>Write buffer to stream.</summary>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="stream"/> is <see langword="null"/>.</exception>
        int Write<T>(T model, Stream stream) where T : IPeripheralBaseMessageType<TMessageType>;
