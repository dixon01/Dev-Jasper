...
namespace Luminator.PeripheralProtocol.Core.Interfaces
{
    ...
    /// <typeparam name="TMessageType">Message Type Enum used in Header to define the various messages</typeparam>
    public interface IPeripheralSerialClient<TMessageType> : IDisposable
    {
        ...
        event EventHandler<PeripheralImageUpdateInfoEventArgs> PeripheralImageUpdateInfoChanged;
        ...
        IPeripheralHandler<TMessageType> PeripheralHandler { get; set; }
        ...
        PeripheralState<TMessageType> State { get; set; }
        ...
        IPeripheralHandler<TMessageType> CreatePeripheralHandler(PeripheralConfig config);
        ...
        object RemoveNextMessage(PeripheralState<TMessageType> peripheralState);
        ...
        int Write<T>(T model, bool waitForAck) where T : IPeripheralBaseMessageType<TMessageType>;
        ...
        /// <exception cref="IOException">An I/O error occurs. </exception>
        IPeripheralBaseMessageType<TMessageType> WriteRequestVersion<TSource>(TSource model) where TSource : IPeripheralBaseMessageType<TMessageType>;
