...
namespace AudioSwitch.Test
{
    ...
    public class AudioSwitchTest
    {
        ...
        // [TestMethod]
        /// <summary>The audio switch serial client_ ack test.</summary>
        public void AudioSwitchSerialClient_AckTest()
        {
            var result = AudioSwitchSerialClientSerialTest<PeripheralAck>(null);
            Assert.IsTrue(result);
        }

        /// <summary>The create audio switch client.</summary>
        [TestMethod]
        public void AudioSwitchSerialClient_Construct()
        {
        ...
        // [TestMethod]
        /// <summary>The audio switch serial client_ hello world.</summary>
        public void AudioSwitchSerialClient_HelloWorld()
        {
            var result = AudioSwitchSerialClientSerialTest<IPeripheralBaseMessage>(Encoding.UTF8.GetBytes("HelloWorld"));
            Assert.IsTrue(result);
        }
        ...
        public void AudioSwitchSerialClient_SetVolumes()
        {
            lock (AudioSwitchClientLock)
            {
                var responseBytes = new PeripheralAck().ToBytes();
        ...
        {
            var state = new PeripheralState(CreatePeripheralContext());
        ...
        public void AudioSwitchState_RemoveGpioStatusMessages()
        {
            ...
            state.AppendStream(msg1);
            var peripheralContext = CreatePeripheralContext(string.Empty); // use memory stream
        ...
        public void AudioSwitchState_RemovePartialMessages()
        {
            ...
            var r = new Random();
            var msg2Size = r.Next(PeripheralHeader.Size, msg2.Length);
            state.AppendStream(frameByte);
            state.AppendStream(msg1);
        ...
        [TestMethod]
        public void CheckSumPeripheralAck()
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralAck)));
            var model = new PeripheralAck();
            Assert.AreEqual(PeripheralAck.Size, model.Header.Length);
            var bytes = model.ToBytes();
            Assert.AreEqual(Marshal.SizeOf(typeof(PeripheralAck)), bytes.Length);
            Assert.AreEqual(0x5, model.Checksum);
        ...
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralAudioConfig)));
            ...
            Assert.AreEqual(Marshal.SizeOf(typeof(PeripheralAudioConfig)), bytes.Length, "PeripheralAudioConfig Size != bytes.Length");
        ...
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralAudioGpioStatus)));
        ...
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralAudioStatus)));
            var model = new PeripheralAudioStatus();
            Assert.AreEqual(PeripheralAudioStatus.Size, model.Header.Length);
            var bytes = model.ToBytes();
            Assert.AreEqual(Marshal.SizeOf(typeof(PeripheralAudioStatus)), bytes.Length);
        ...
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralAudioVersions)));
            var model = new PeripheralAudioVersions();
            var bytes = model.ToBytes();
            Assert.AreEqual(Marshal.SizeOf(typeof(PeripheralAudioVersions)), bytes.Length, "Expected Sizeof != bytes.Length");
        ...
        [TestMethod]
        public void CheckSumPeripheralNak()
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralNak)));
            var model = new PeripheralNak();
            var bytes = model.ToBytes();
            Assert.AreEqual(PeripheralNak.Size, bytes.Length, "Expected bytes length off");
            Assert.AreEqual(PeripheralNak.Size, model.Header.Length);
            Assert.AreEqual(0x4, model.Checksum);
            Debug.WriteLine("checksum = 0x{0:X}", model.Checksum);
            model.Checksum = CheckSumUtil.CalculateCheckSum(model);
            bytes = model.ToBytes();
            var valid = CheckSumUtil.IsValidChecksum(bytes);
        ...
        {
            var model = new PeripheralPoll();
            Assert.AreEqual(PeripheralPoll.Size, model.Header.Length);
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralPoll)));
            var bytes = model.ToBytes();
            Assert.AreEqual(PeripheralPoll.Size, bytes.Length, "Expected bytes length off");
            Assert.AreEqual(0x8, model.Checksum); // this will change if the class defaults are altered!
            Debug.WriteLine("checksum = 0x{0:X}", model.Checksum);
            model.Checksum = CheckSumUtil.CalculateCheckSum(model);
            bytes = model.ToBytes();
            var valid = CheckSumUtil.IsValidChecksum(bytes);
        ...
        {
            Debug.WriteLine("MarshalSize = " + Marshal.SizeOf(typeof(PeripheralSetVolume)));
            var model = new PeripheralSetVolume(10, 20);
        ...
        {
            var audioSwitchContext = CreatePeripheralContext();
        ...
        public void CreateAudioSwitchHandlerFromFactory()
        {
            ...
            var defaultContext = CreatePeripheralContext();
        ...
        /// <summary>The extension_ find peripheral message type.</summary>
        [TestMethod]
        public void Extension_FindPeripheralMessageType()
        {
            PeripheralMessageType type = PeripheralMessageType.Ack;
            var modelType = type.FindPeripheralMessageType();
            Assert.AreEqual(typeof(PeripheralAck), modelType);
            type = PeripheralMessageType.Nak;
            modelType = type.FindPeripheralMessageType();
            Assert.AreEqual(typeof(PeripheralNak), modelType);
        }
        ...
        {
            PeripheralMessageType msgType = PeripheralMessageType.Ack;
            Type messageType = msgType.FindPeripheralMessageType();
        ...
        {
            PeripheralMessageType msgType = PeripheralMessageType.AudioConfig;
            Type messageType = msgType.FindPeripheralMessageType();
        ...
        {
            PeripheralMessageType msgType = PeripheralMessageType.GpioStatusResponse;
            Type messageType = msgType.FindPeripheralMessageType();
        ...
        {
            PeripheralMessageType msgType = PeripheralMessageType.AudioVersionResponse;
            Type messageType = msgType.FindPeripheralMessageType();
            Assert.AreEqual(typeof(PeripheralAudioVersions), messageType);
        }

        /// <summary>The find peripheral nak_ from message type.</summary>
        [TestMethod]
        public void FindPeripheralNak_FromMessageType()
        {
            PeripheralMessageType msgType = PeripheralMessageType.Nak;
            Type messageType = msgType.FindPeripheralMessageType();
        ...
        public T FromBytesToObjectTest<T>(byte[] modelBytes = null, T sourceModel = null) where T : class, IPeripheralBaseMessage
        {
            T createdModel = default(T);
            using (var audioSwitchHandler = new AudioSwitchHandler(CreatePeripheralContext()))
            {
                ...
                var expectedSize = Marshal.SizeOf(typeof(T));
        ...
        {
            var model = this.FromBytesToObjectTest<PeripheralAck>();
            Assert.IsNotNull(model);
            Assert.AreEqual(typeof(PeripheralAck), model.GetType());
        }
        ...
        [TestMethod]
        public void FromBytesToPeripheralNak()
        {
            var model = FromBytesToObjectTest<PeripheralNak>();
            Assert.IsNotNull(model);
            Assert.AreEqual(typeof(PeripheralNak), model.GetType());
        }
        ...
        {
            var m = new PeripheralHeader();
            var bytes = m.ToBytes();
            Assert.AreEqual(PeripheralHeader.Size, bytes.Length);
        }
        ...
        public void GetPropertyInfoFromPeripheralHeader()
        {
            ...
            var propInfo = typeof(PeripheralHeader).GetProperties();
        ...
        public void PeripheralAudioConfig_FromMemoryByteStream()
        {
            lock (AudioSwitchClientLock)
            {
                ...
                var a = new AudioSwitchHandler(new PeripheralContext(new AudioSwitchPeripheralConfig(), memStream));
        ...
        public void PeripheralHeaderToBytes()
        {
            ...
            Assert.AreEqual(PeripheralHeader.Size, bytes.Length, "Expected length incorrect");
        ...
        {
            var modelSrc = new PeripheralHeader();
            var modelDest = modelSrc.HostToNetworkByteOrder();
            Assert.AreEqual(0x0600, modelDest.Length);
            Assert.AreEqual(0x00F0, modelDest.Address);
            Assert.AreEqual(modelSrc.MessageType, modelDest.MessageType);
            Assert.AreEqual(modelSrc.SystemType, modelDest.SystemType);

            var expected = modelDest.HostToNetworkByteOrder();
            Assert.AreEqual(modelSrc.Length, expected.Length);
            Assert.AreEqual(modelSrc.Address, expected.Address);
            Assert.AreEqual(modelSrc.MessageType, expected.MessageType);
            Assert.AreEqual(modelSrc.SystemType, expected.SystemType);
        }
        ...
        public void ReadWriteNak()
        {
            ...
            stream.Position = 0;
            var model = audioSwitchHandler.Read<PeripheralNak>();
            Assert.IsNotNull(model);
        }
            ...
            var header = new PeripheralHeader
                             {
                                 Address = 0x0, 
                                 Length = 6, 
                                 MessageType = PeripheralMessageType.Unknown, 
                                 SystemType = PeripheralSystemMessageType.Default
                             };
            var xml = SerializeToXml<PeripheralHeader>();
            Debug.WriteLine(xml);
            Debug.WriteLine("\r\nToString() = {0}", header);
        }
        ...
        {
            ValidateSize<PeripheralMessageType>(1);
        }
        ...
        public void ValidatePeripheralImageUpdateStart()
        {
            ...
            Assert.AreEqual(PeripheralMessageType.ImageUpdateStart, model.Header.MessageType);
        }
        ...
        public void ValidatePollAudioStatus()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.Default, message.Header.SystemType);
        }
        ...
        public void ValidateSize_PeripheralAck()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.Default, model.Header.SystemType);
        }
        ...
        public void ValidateSize_PeripheralAudioConfig()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.AudioGeneration3, model.Header.SystemType);
            Assert.AreEqual(PeripheralMessageType.AudioConfig, model.Header.MessageType);
        }
        ...
        public void ValidateSize_PeripheralAudioEnable()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.AudioGeneration3, model.Header.SystemType);
            Assert.AreEqual(PeripheralMessageType.AudioOutputEnable, model.Header.MessageType);
        }
        ...
        {
            ValidateSize<PeripheralBaseMessage>(PeripheralBaseMessage.Size);
            var size = Marshal.SizeOf(typeof(PeripheralBaseMessage));
            Assert.AreEqual(PeripheralBaseMessage.Size, size);
        }
        ...
        public void ValidateSize_PeripheralGpioNotification()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.AudioGeneration3, model.Header.SystemType);
            Assert.AreEqual(PeripheralMessageType.GpioStatusResponse, model.Header.MessageType);
            Assert.AreEqual(PeripheralAudioGpioStatus.Size, model.Header.Length);
        }
        ...
        {
            var model = ValidateSize<PeripheralHeader>(PeripheralHeader.Size);
            Assert.AreEqual(Constants.DefaultPeripheralAddress, model.Address, "Address wrong default");
            Assert.AreEqual(PeripheralHeader.DefaultSystemType, model.SystemType, "SystemType wrong default");
        ...
        {
            ValidateSize<PeripheralImageRecord>(PeripheralImageRecord.Size);
        }
        ...
        public void ValidateSize_PeripheralPollAudioStatus()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.Default, model.Header.SystemType);
            Assert.AreEqual(PeripheralMessageType.Poll, model.Header.MessageType);
        }
        ...
        public void ValidateSize_PeripheralSetVolume()
        {
            ...
            Assert.AreEqual(PeripheralSystemMessageType.AudioGeneration3, model.Header.SystemType);
            Assert.AreEqual(PeripheralMessageType.SetVolume, model.Header.MessageType);
        }
        ...
        {
            var checkSumPropInfo = typeof(PeripheralBaseMessage).GetProperties().SingleOrDefault(m => m.Name.Contains("Checksum"));
                    ...
                    client.PeripheralDataReceived += (sender, args) =>
                        {
                            ...
                            if (message.Header.MessageType == PeripheralMessageType.Ack)
                            {
            ...
            where T : class, IPeripheralBaseMessage
        {
            ...
            lock (AudioSwitchClientLock)
            {
                ...
                PeripheralHeader responeHeader = PeripheralHeader.Create(replyBytes);
        ...
        private static void AssertValidateMessage<T>(object message) where T : class, IPeripheralBaseMessage
        {
            Assert.IsNotNull(message);
        ...
        private static PeripheralContext CreatePeripheralContext(
            string comPort = "", 
            string configFileName = AudioSwitchPeripheralConfig.DefaultAudioSwitchConfigFileName)
        {
            ...
            return new PeripheralContext(audioSwitchConfig, new MemoryStream());
        }
        ...
        private T ValidateSize<T>(int expectedSize)
        {
            ...
            if (propInfo != null)
            {
                ...
                var peripheralBaseMessage = model as IPeripheralBaseMessage;
