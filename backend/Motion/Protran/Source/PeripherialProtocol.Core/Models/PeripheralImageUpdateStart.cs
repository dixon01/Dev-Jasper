// --------------------------------------------------------------------------------------------------------------------
// <copyright company="Luminator Technology Group" file="Class1.cs">
...
namespace Luminator.PeripheralProtocol.Core.Models
{
    ...
    public class PeripheralImageUpdateStart : IPeripheralImageUpdateStart
    {
        ...
        public const int Size = PeripheralHeader.Size + sizeof(ushort) + sizeof(byte);

        /// <summary>Initializes a new instance of the <see cref="PeripheralImageUpdateStart"/> class. Initializes a new instance of the<see cref="Luminator.PeripheralProtocol.Core.Models.PeripheralImageUpdateStart"/> class. Initializes a new
        ...
        public PeripheralImageUpdateStart(ushort records, ushort address = Constants.DefaultPeripheralAddress, PeripheralSystemMessageType systemMessageType = PeripheralSystemMessageType.AudioGeneration3)
        {
            this.Header = new PeripheralHeader()
            {
                MessageType = PeripheralMessageType.ImageUpdateStart,
        ...
        {
            this.Header = new PeripheralHeader(PeripheralMessageType.ImageUpdateStart, Size);
        }
