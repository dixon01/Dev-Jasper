...
namespace Luminator.PeripheralProtocol.Core
{
    ...
    public class PeripheralState : IPeripheralState
    {
        #region Constants
        ...
        // protected readonly ReaderWriterLock ReadWriteLock = new ReaderWriterLock();
        ...
        public PeripheralState(PeripheralContext context)
        {
        ...
        public PeripheralMessageType LastMessageType { get; set; }
        ...
        public PeripheralContext PeripheralContext { get; private set; }
