...
namespace Luminator.PeripheralProtocol.Core
{
    ...
    public class PeripheralContext : IPeripheralContext
    {
        ...
        public PeripheralContext(PeripheralConfig config, IPeripheralSerialClient peripheralSerialClient)
        {
            this.Config = config;
        ...
        public IPeripheralSerialClient PeripheralSerialClient { get; set; }
