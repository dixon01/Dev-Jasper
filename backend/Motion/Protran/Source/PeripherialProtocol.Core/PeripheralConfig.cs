...
namespace Luminator.PeripheralProtocol.Core
{
    ...
    public class PeripheralConfig : IPeripheralConfig
    {
            ...
            : this("COM1", DefaultBaudRate, 8, Parity.None, StopBits.One, false, false)
        {
            ...
            this.MaxWritesWhenWaitForAck = Constants.DefaultMaxWritesWhenWaitForAck;
            this.WaitForAckTimeout = Constants.DefaultWaitForAckTimeout;
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="PeripheralConfig" /> class. Initializes a new instance of the
        ///     <see cref="Gorba.Common.Configuration.Obc.Common.SerialPortConfig" /> class.
        /// </summary>
        ...
        /// <param name="receivedBytesThreshold">
        ///     The number of bytes in the internal input buffer before a DataReceived event
        ///     occurs.
        /// </param>
        public PeripheralConfig(
            string comPort, 
        ...
        /// <summary>Gets or sets the default max peripheral framing bytes to write in the stream on TX to the endpoint default = 1.</summary>
        [XmlElement]
        ...
        /// <summary>Gets or sets the max writes when wait for ACK.</summary>
        [XmlElement, DefaultValue(Constants.DefaultMaxWritesWhenWaitForAck)]
        public int MaxWritesWhenWaitForAck { get; set; }
        ...
        [XmlElement, DefaultValue(Constants.DefaultWaitForAckTimeout)]
        public int WaitForAckTimeout { get; set; }
