...
namespace DNSServiceBrowser_NET
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private Bonjour.DNSSDService addressQuery;
        ...
        public Form1()
        {
            ...
            eventManager.AddressFound += this.AddressFound;
            
            service = new DNSSDService();
        }

        private void AddressFound(
                        ...
                        )
        {
            ...
            this.addressQuery = service.GetAddrInfo(
                0, ifIndex, DNSSDAddressFamily.kDNSSDAddressFamily_IPv4, hostName, eventManager);
        }
