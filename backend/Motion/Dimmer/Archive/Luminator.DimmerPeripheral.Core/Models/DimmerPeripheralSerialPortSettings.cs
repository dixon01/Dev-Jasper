namespace Luminator.DimmerPeripheral.Core.Models
{
    ...
    [Serializable]
    public class DimmerPeripheralSerialPortSettings : IDimmerPeripheraISerialPortSettings
    {
        #region Constants
        ...
        /// <summary>Initializes a new instance of the <see cref="DimmerPeripheralSerialPortSettings" /> class.</summary>
        public DimmerPeripheralSerialPortSettings()
            : this(string.Empty)
        {
        }
        ...
        /// <returns>The <see cref="DimmerPeripheralSerialPortSettings"/>.</returns>
        public static DimmerPeripheralSerialPortSettings Read(string fileName)
        {
            using (var streamReader = new StreamReader(File.Open(fileName, FileMode.Open)))
            {
                var xmlSerializer = new XmlSerializer(typeof(DimmerPeripheralSerialPortSettings));
                return (DimmerPeripheralSerialPortSettings)xmlSerializer.Deserialize(streamReader);
            }
        }
        ...
        public static void Write(string fileName, DimmerPeripheralSerialPortSettings settings)
        {
