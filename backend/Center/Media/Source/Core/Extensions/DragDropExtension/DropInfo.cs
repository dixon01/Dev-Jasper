// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DropInfo.cs" company="Gorba AG">
...
namespace Gorba.Center.Media.Core.Extensions.DragDropExtension
{
    ...
    public class DropInfo : IDropInfo
    {
        ...
        {
            var dataFormat = DragDropHelper.DataFormat.Name;
            ...
            if (!(this.VisualTarget is ItemsControl))
            {
                ...
                if (itemsControl != null)
                {
                    ...
                    if (DragDropHelper.GetIsDropTarget(itemsControl))
                    {
        ...
        /// <summary>
        /// Gets or sets  and sets the text displayed in the DropDropEffects adorner.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the not the drop was handled or not
        /// </summary>
