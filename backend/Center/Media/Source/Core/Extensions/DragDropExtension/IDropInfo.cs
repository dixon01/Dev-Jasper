// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDropInfo.cs" company="Gorba AG">
...
namespace Gorba.Center.Media.Core.Extensions.DragDropExtension
{
    ...
    public interface IDropInfo
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the drop info should be handled by itself (useful for child elements)
        /// </summary>
