// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CaseDynamicPropertyDataViewModel.partial.cs" company="Gorba AG">
...
namespace Gorba.Center.Media.Core.DataViewModels.Eval
{
    ...
    /// </summary>
    public partial class CaseDynamicPropertyDataViewModel
    {
        /// <summary>
        ...
        public string HumanReadable()
        {
            ...
            return string.Format("'{0}':{1}", valueString, evaluationString);
        }
