// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GreaterThanOrEqualEvalDataViewModel.partial.cs" company="Gorba AG">
...
{
    /// <summary>
    /// The greater than or equal evaluation data view model.
    /// </summary>
    public partial class GreaterThanOrEqualEvalDataViewModel
    {
        /// <summary>
