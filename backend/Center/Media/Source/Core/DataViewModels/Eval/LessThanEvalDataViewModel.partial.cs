// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LessThanEvalDataViewModel.partial.cs" company="Gorba AG">
...
{
    /// <summary>
    /// The less than evaluation data view model.
    /// </summary>
    public partial class LessThanEvalDataViewModel
    {
        /// <summary>
