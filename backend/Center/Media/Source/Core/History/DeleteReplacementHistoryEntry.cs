// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DeleteReplacementHistoryEntry.cs" company="Gorba AG">
...
namespace Gorba.Center.Media.Core.History
{
    ...
    /// </summary>
    public class DeleteReplacementHistoryEntry : HistoryEntryBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteReplacementHistoryEntry"/> class.
        /// </summary>
        ...
        /// </param>
        public DeleteReplacementHistoryEntry(
