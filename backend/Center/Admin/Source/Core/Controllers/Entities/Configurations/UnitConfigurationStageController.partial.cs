// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitConfigurationStageController.partial.cs" company="Gorba AG">
//   Copyright © 2011-2015 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the UnitConfigurationController type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Center.Admin.Core.Controllers.Entities.Configurations
{
    ...
    /// <summary>
    /// Partial implementation of the special behavior of the <see cref="UnitConfigurationStageController"/>.
    /// </summary>
    public partial class UnitConfigurationStageController
    {
        /// <summary>
        ...
        {
            this.UpdatePermissions(DataScope.UnitConfiguration);
        }
    }
}
