// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PackageStageController.partial.cs" company="Gorba AG">
//   Copyright © 2011-2015 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the PackageController type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Center.Admin.Core.Controllers.Entities.Software
{
    ...
    /// <summary>
    /// Partial implementation of the special behavior of the <see cref="PackageStageController"/>.
    /// </summary>
    public partial class PackageStageController
    {
        /// <summary>
