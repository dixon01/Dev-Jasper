// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UpdateCommandStageController.partial.cs" company="Gorba AG">
//   Copyright © 2011-2015 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the UpdateCommandController type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Center.Admin.Core.Controllers.Entities.Update
{
    ...
    /// <summary>
    /// Partial implementation of the special behavior of the <see cref="UpdateCommandStageController"/>.
    /// </summary>
    public partial class UpdateCommandStageController
    {
        /// <summary>
