// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UpdatePartStageController.partial.cs" company="Gorba AG">
//   Copyright © 2011-2015 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the UpdatePartController type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Center.Admin.Core.Controllers.Entities.Update
{
    ...
    /// <summary>
    /// Partial implementation of the special behavior of the <see cref="UpdatePartStageController"/>.
    /// </summary>
    public partial class UpdatePartStageController
    {
        /// <summary>
