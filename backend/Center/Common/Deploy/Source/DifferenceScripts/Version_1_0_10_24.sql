...
ALTER TABLE [dbo].[AlarmSet] DROP CONSTRAINT [FK_AlarmSet_AlarmTypeSet]
GO
ALTER TABLE [dbo].[AlarmSet] DROP CONSTRAINT [FK_AlarmSet_UnitSet]
GO
ALTER TABLE [dbo].[AlarmSet] DROP CONSTRAINT [FK_AlarmSet_UserSet]
GO
ALTER TABLE [dbo].[AlarmSet] DROP CONSTRAINT [FK_AlarmSet_AlarmStatusTypeSet]
GO
...
INSERT INTO [dbo].[TempAlarmSet] ([Id],[UnitId],[UserId],[Description],[ConfirmationText],[DateCreated],[DateConfirmed],[IsDeleted],[Title],[Severity],[Type]) SELECT [Id],[UnitId],[UserId],[Description],[ConfirmationText],[DateCreated],[DateConfirmed],[IsDeleted],'',0,0 FROM [dbo].[AlarmSet]
...
EXECUTE @RC = [Gorba_CenterOnline].[dbo].[DatabaseVersion_Insert] 
   @name = 'Version 1.0.10.24'
  ,@description = 'Updated the alarms. Removed the alarm type and status from alarms.'
  ,@versionMajor = 1
  ,@versionMinor = 0
  ,@versionBuild = 10
  ,@versionRevision = 24
  ,@dateCreated = '2012-04-20T10:10:00.000'
GO
