namespace Luminator.AdhocMessaging.Models
{
    ...
    public class Unit
    {
        ...
        {
            return
                $" Unit {nameof(this.Id)}: {this.Id}, {nameof(this.Name)}: {this.Name}, {nameof(this.Description)}: {this.Description}, {nameof(this.IsActive)}: {this.IsActive}, {nameof(this.IsConnected)}: {this.IsConnected},  {nameof(this.CreatedOn)}: {this.CreatedOn}, {nameof(this.LastModifiedOn)}: {this.LastModifiedOn},  {nameof(this.NetworkAddress)}: {this.NetworkAddress}, {nameof(this.ProductTypeId)}: {this.ProductTypeId}, {nameof(this.TenantId)}: {this.TenantId}, {nameof(this.UpdateGroupId)}: {this.UpdateGroupId},  {nameof(this.Version)}: {this.Version}";
        }
    }
}