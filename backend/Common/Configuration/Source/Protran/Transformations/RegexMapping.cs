// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RegexMapping.cs" company="Gorba AG">
...
namespace Gorba.Common.Configuration.Protran.Transformations
{
    ...
    /// </summary>
    [Serializable]
    public class RegexMapping : TransformationConfig
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegexMapping"/> class.
        /// </summary>
        public RegexMapping()
        {
