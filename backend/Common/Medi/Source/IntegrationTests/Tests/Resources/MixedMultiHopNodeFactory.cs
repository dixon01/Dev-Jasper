// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MixedMultiHopNodeFactory.cs" company="Gorba AG">
//   Copyright © 2011-2015 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Node factory that creates six nodes on three units: A:1 - A:2 - B:1 - B:2 - C:1 - C:2.
//   The units only have one resource service each.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Gorba.Common.Medi.IntegrationTests.Tests.Resources
{
    ...
    /// </summary>
    public class MixedMultiHopNodeFactory : INodeFactory
    {
        /// <summary>
