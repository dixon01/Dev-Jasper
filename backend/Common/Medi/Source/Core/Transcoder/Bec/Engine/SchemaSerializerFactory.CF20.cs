// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SchemaSerializerFactory.CF20.cs" company="Gorba AG">
...
namespace Gorba.Common.Medi.Core.Transcoder.Bec.Engine
{
    ...
    internal abstract partial class SchemaSerializerFactory
    {
        ...
        /// </param>
        /// <returns>
        /// A <see cref="ReflectionSchemaSerializerFactory"/>.
        /// </returns>
            ...
            switch (serializer)
            {
                case BecCodecConfig.SerializerType.Generated:
                    throw new NotSupportedException(
                        "Generated serializers are not supported in .NET Compact Framework");
                default:
