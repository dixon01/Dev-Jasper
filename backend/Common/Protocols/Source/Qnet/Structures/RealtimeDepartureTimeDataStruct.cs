// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RealtimeDepartureTimeDataStruct.cs" company="Gorba AG">
...
namespace Gorba.Common.Protocols.Qnet.Structures
{
    ...
    public unsafe struct RealtimeDepartureTimeDataStruct
    {
        /// <summary>
        ...
        /// Text of voice text
        /// </summary>
        private fixed byte internalText[MessageConstantes.MaxLedMatrixDisplayTimeTextLenght];

        /// <summary>
        /// Gets or sets the text corresponding to the departure time.
        /// </summary>
        public string Text
        {
            get
            {
                fixed (byte* ptr = this.internalText)
                {
                    return StructuresHelper.UnsafeCopyByteArrayPtrToString(
                        ptr, MessageConstantes.MaxLedMatrixDisplayTimeTextLenght);
                }
            }
            ...
            set
            {
                fixed (byte* ptr = this.internalText)
                {
                    StructuresHelper.UnsafeCopyStringToByteArrayPtr(
                        value, ptr, MessageConstantes.MaxLedMatrixDisplayTimeTextLenght);
                }
            }
        }
    }
