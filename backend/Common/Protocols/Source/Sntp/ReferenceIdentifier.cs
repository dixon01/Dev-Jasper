// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferenceIdentifier.cs" company="Gorba AG">
...
namespace Gorba.Common.Protocols.Sntp
{
    ...
    public enum ReferenceIdentifier : uint
    {
        ...
        /// <summary>
        /// Un-calibrated local clock used as a primary reference for a subnet
