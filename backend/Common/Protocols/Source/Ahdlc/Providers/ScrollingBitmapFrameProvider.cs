// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScrollingBitmapFrameProvider.cs" company="Gorba AG">
...
namespace Gorba.Common.Protocols.Ahdlc.Providers
{
    ...
    /// <summary>
    /// Provider for scrolling bitmap frames (mode 0x01).
    /// </summary>
    public class ScrollingBitmapFrameProvider : MonochromeBitmapFrameProviderBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollingBitmapFrameProvider"/> class.
        /// </summary>
        ...
        /// The height.
        /// </param>
        public ScrollingBitmapFrameProvider(IMonochromePixelSource pixelSource, int height)
        ...
        /// The brightness.
        /// </param>
        public ScrollingBitmapFrameProvider(IMonochromePixelSource pixelSource, int height, Brightness brightness)
        {
            ...
            var setup = new SetupCommandFrame(DisplayMode.ScrollingBitmap) { DataBlockCount = this.blockCount };
