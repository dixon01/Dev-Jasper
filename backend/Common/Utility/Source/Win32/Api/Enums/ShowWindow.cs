// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ShowWindow.cs" company="Gorba AG">
//   Copyright © 2011-2015 Gorba AG. All rights reserved.
// </copyright>
// <summary>
//   Defines the ShowWindow type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// The possible values for <see cref="Gorba.Common.Utility.Win32.Api.DLLs.User32.ShowWindow"/>.
    /// </summary>
    public enum ShowWindow
    {
        ...
        /// <summary>
        /// Sets the show state based on the SW_ value specified in the <c>STARTUPINFO</c>
