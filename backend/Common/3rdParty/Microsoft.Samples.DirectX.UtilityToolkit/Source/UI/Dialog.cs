namespace Microsoft.Samples.DirectX.UtilityToolkit
{
    ...
    public class Dialog
    {
        ...
        public Framework SampleFramework { get { return this.parent; } }
        ...
        public bool IsUsingNonUserEvents { get { return this.usingNonUserEvents; } set { this.usingNonUserEvents = value; } }
        /// <summary>Is the dilaog using keyboard input</summary>
        public bool IsUsingKeyboardInput { get { return this.usingKeyboardInput; } set { this.usingKeyboardInput = value; } }
        /// <summary>Is the dilaog using mouse input</summary>
        public bool IsUsingMouseInput { get { return this.usingMouseInput; } set { this.usingMouseInput = value; } }
        /// <summary>Is the dilaog minimized</summary>
        public bool IsMinimized { get { return this.isDialogMinimized; } set { this.isDialogMinimized = value; } }
        /// <summary>Called to set dialog's location</summary>
        public void SetLocation(int x, int y) { this.dialogX = x; this.dialogY = y; this.UpdateVertices(); }
        /// <summary>The dialog's location</summary>
        public System.Drawing.Point Location { 
            get {return new System.Drawing.Point(this.dialogX, this.dialogY); } 
            set { this.dialogX = value.X; this.dialogY = value.Y; this.UpdateVertices(); } 
        }

        /// <summary>Called to set dialog's size</summary>
        public void SetSize(int w, int h) { this.width = w; this.height = h; this.UpdateVertices();}
        ...
        public void SetCaptionText(string text) { this.caption = text; }
        /// <summary>The dialog's caption height</summary>
        public int CaptionHeight { get { return this.captionHeight; } set { this.captionHeight = value; } }
        /// <summary>Called to set dialog's caption enabled state</summary>
        public void SetCaptionEnabled(bool isEnabled) { this.hasCaption = isEnabled; }
        ...
        { 
            this.topLeftColor = topLeft; this.topRightColor = topRight; this.bottomLeftColor = bottomLeft; this.bottomRightColor = bottomRight;
            this.UpdateVertices();
        }
        /// <summary>Called to set dialog's border colors</summary>
        public void SetBackgroundColors(ColorValue allCorners) { this.SetBackgroundColors(allCorners, allCorners, allCorners, allCorners); }
        ...
        {
            this.parent = sample; // store this for later use
            // Initialize to default state
            this.dialogX = 0; this.dialogY = 0; this.width = 0; this.height = 0;
            this.hasCaption = false; this.isDialogMinimized = false; 
            this.caption = string.Empty;
            this.captionHeight = 18;

            this.topLeftColor = this.topRightColor = this.bottomLeftColor = this.bottomRightColor = new ColorValue();

            this.timeLastRefresh = 0.0f;
            
            this.nextDialog = this; // Only one dialog
            this.prevDialog = this;  // Only one dialog

            this.usingNonUserEvents = false;
        ...
        {
            this.SetTexture(0, "UI\\DXUTControls.dds");
            this.SetFont(0, "Arial", 14, FontWeight.Normal);

            //-------------------------------------
            // Element for the caption
            //-------------------------------------
            this.captionElement = new Element();
            this.captionElement.SetFont(0, WhiteColorValue, DrawTextFormat.Left | DrawTextFormat.VerticalCenter);
            this.captionElement.SetTexture(0, System.Drawing.Rectangle.FromLTRB(17, 269, 241, 287));
            this.captionElement.TextureColor.States[(int)ControlState.Normal] = WhiteColorValue;
            this.captionElement.FontColor.States[(int)ControlState.Normal] = WhiteColorValue;
            // Pre-blend as we don't need to transition the state
            this.captionElement.TextureColor.Blend(ControlState.Normal, 10.0f);
            this.captionElement.FontColor.Blend(ControlState.Normal, 10.0f);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.StaticText, StaticText.TextElement, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.Button, Button.ButtonLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.Button, Button.FillLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.CheckBox, Checkbox.BoxLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.CheckBox, Checkbox.CheckLayer, e);
            ...
            e.TextureColor.States[(int)ControlState.Pressed] = WhiteColorValue;
            // Assign the element
            this.SetDefaultElement(ControlType.RadioButton, RadioButton.BoxLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.RadioButton, RadioButton.CheckLayer, e);
            ...
            e.FontColor.States[(int)ControlState.Disabled] = new ColorValue(0.8f, 0.8f, 0.8f, 0.8f);
            // Assign the element
            this.SetDefaultElement(ControlType.ComboBox, ComboBox.MainLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.ComboBox, ComboBox.ComboButtonLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.ComboBox, ComboBox.DropdownLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.ComboBox, ComboBox.SelectionLayer, e);
            ...
            e.TextureColor.States[(int)ControlState.Disabled] = new ColorValue(1.0f, 1.0f, 1.0f, 0.25f);
            // Assign the element
            this.SetDefaultElement(ControlType.Slider, Slider.TrackLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.Slider, Slider.ButtonLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.Scrollbar, ScrollBar.TrackLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.Scrollbar, ScrollBar.UpButtonLayer, e);
            ...
            e.TextureColor.States[(int)ControlState.Disabled] = new ColorValue(0.8f, 0.8f, 0.8f, 1.0f);
            // Assign the element
            this.SetDefaultElement(ControlType.Scrollbar, ScrollBar.DownButtonLayer, e);
            ...
            // Assign the element
            this.SetDefaultElement(ControlType.Scrollbar, ScrollBar.ThumbLayer, e);
            ...
            this.SetDefaultElement(ControlType.EditBox, EditBox.TextLayer, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(8, 82, 14, 90));
            this.SetDefaultElement(ControlType.EditBox, EditBox.TopLeftBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(14, 82, 241, 90));
            this.SetDefaultElement(ControlType.EditBox, EditBox.TopBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(241, 82, 246, 90));
            this.SetDefaultElement(ControlType.EditBox, EditBox.TopRightBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(8, 90, 14, 113));
            this.SetDefaultElement(ControlType.EditBox, EditBox.LeftBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(241, 90, 246, 113));
            this.SetDefaultElement(ControlType.EditBox, EditBox.RightBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(8, 113, 14, 121));
            this.SetDefaultElement(ControlType.EditBox, EditBox.LowerLeftBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(14, 113, 241, 121));
            this.SetDefaultElement(ControlType.EditBox, EditBox.LowerBorder, e);
            e.SetTexture(0, System.Drawing.Rectangle.FromLTRB(241, 113, 246, 121));
            this.SetDefaultElement(ControlType.EditBox, EditBox.LowerRightBorder, e);
            ...
            e.SetFont(0, BlackColorValue, DrawTextFormat.Left | DrawTextFormat.Top);
            // Assign the element
            this.SetDefaultElement(ControlType.ListBox, ListBox.MainLayer, e);
            ...
            e.SetFont(0, WhiteColorValue, DrawTextFormat.Left | DrawTextFormat.Top);
            // Assign the element
            this.SetDefaultElement(ControlType.ListBox, ListBox.SelectionLayer, e);
        }
        ...
        {
            ComboBox comboBox = this.GetComboBox(id);
            if (comboBox == null)
                return;
        ...
        public bool MessageProc(IntPtr hWnd, NativeMethods.WindowMessage msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (this.hasCaption)
            {
                if (msg == NativeMethods.WindowMessage.LeftButtonDown || msg == NativeMethods.WindowMessage.LeftButtonDoubleClick)
                {
                    ...
                    if (mouseX >= this.dialogX && mouseX < this.dialogX + this.width && 
                        mouseY >= this.dialogY && mouseY < this.dialogY + this.captionHeight)
                    {
                        isDragging = true;
                ...
                case NativeMethods.WindowMessage.XButtonDoubleClick:
                    {
                        ...
                        // Offset mouse point
                        mousePoint.X -= this.dialogX;
                        mousePoint.Y -= this.dialogY;

                        // If caption is enabled, offset the Y coordinate by the negative of its height.
                        if (this.hasCaption)
                            mousePoint.Y -= this.captionHeight;
                        ...
                        Control control = this.GetControlAtPoint(mousePoint);
        ...
        private void OnMouseMove(System.Drawing.Point pt)
        {
            ...
            Control control = this.GetControlAtPoint(pt);
            if (control != null)
            {
        ...
        public StaticText GetStaticText(int id) { return this.GetControl(id, ControlType.StaticText) as StaticText; }
        /// <summary>Returns the button control located at this index(if one exists)</summary>
        public Button GetButton(int id) { return this.GetControl(id, ControlType.Button) as Button; }
        /// <summary>Returns the checkbox control located at this index(if one exists)</summary>
        public Checkbox GetCheckbox(int id) { return this.GetControl(id, ControlType.CheckBox) as Checkbox; }
        /// <summary>Returns the radio button control located at this index(if one exists)</summary>
        public RadioButton GetRadioButton(int id) { return this.GetControl(id, ControlType.RadioButton) as RadioButton; }
        /// <summary>Returns the combo box control located at this index(if one exists)</summary>
        public ComboBox GetComboBox(int id) { return this.GetControl(id, ControlType.ComboBox) as ComboBox; }
        /// <summary>Returns the slider control located at this index(if one exists)</summary>
        public Slider GetSlider(int id) { return this.GetControl(id, ControlType.Slider) as Slider; }
        /// <summary>Returns the listbox control located at this index(if one exists)</summary>
        public ListBox GetListBox(int id) { return this.GetControl(id, ControlType.ListBox) as ListBox; }
        #endregion
        ...
        public void SetDefaultElement(ControlType ctype, uint index, Element e)
        {
            ...
            for (int i = 0; i < this.defaultElementList.Count; i++)
            {
                ElementHolder holder = (ElementHolder)this.defaultElementList[i];
                if ( (holder.ControlType == ctype) &&
                     (holder.ElementIndex == index) )
                {
                    // Found it, update it
                    holder.Element = e.Clone();
                    this.defaultElementList[i] = holder;
                    return;
                }
            }
            ...
            // Add it now
            this.defaultElementList.Add(newEntry);
        }
        /// <summary>
        ...
        public void SetFont(uint index, string faceName, uint height, FontWeight weight)
        {
            ...
            for (uint i = (uint)this.fontList.Count; i <= index; i++)
                this.fontList.Add((int)(-1));

            int fontIndex = DialogResourceManager.GetGlobalInstance().AddFont(faceName, height, weight);
            this.fontList[(int)index] = fontIndex;
        }
        /// <summary>
        /// Shared resource access. Indexed fonts and textures are shared among
        /// all the controls.
        ...
        {
            return DialogResourceManager.GetGlobalInstance().GetFontNode((int)this.fontList[(int)index]);
        }
        /// <summary>
        /// Shared resource access. Indexed fonts and textures are shared among
        /// all the controls.
        ...
        {
            // Make sure the list is at least big enough to hold this index
            for (uint i = (uint)this.textureList.Count; i <= index; i++)
                this.textureList.Add((int)(-1));

            int textureIndex = DialogResourceManager.GetGlobalInstance().AddTexture(filename);
            this.textureList[(int)index] = textureIndex;
        }
        /// <summary>
        /// Shared resource access. Indexed fonts and textures are shared among
        /// all the controls.
        ...
        {
            return DialogResourceManager.GetGlobalInstance().GetTextureNode((int)this.textureList[(int)index]);
        }
        #endregion
        ...
        public void InitializeControl(Control control)
        {
            ...
            // Set the index
            control.index = (uint)this.controlList.Count;
        ...
        /// <summary>Adds a static text control to the dialog</summary>
        public StaticText AddStatic(int id, string text, int x, int y, int w, int h){return this.AddStatic(id, text, x, y, w, h, false); }
        ...
        /// <summary>Adds a button control to the dialog</summary>
        public Button AddButton(int id, string text, int x, int y, int w, int h) { return this.AddButton(id, text, x, y, w, h, 0, false); }
        ...
        public Checkbox AddCheckBox(int id, string text, int x, int y, int w, int h, bool ischecked) { return this.AddCheckBox(id, text, x, y, w, h, ischecked, 0, false); }
        ...
        public RadioButton AddRadioButton(int id, uint groupId, string text, int x, int y, int w, int h, bool ischecked) { return this.AddRadioButton(id, groupId, text, x, y, w, h, ischecked, 0, false); }
        ...
        /// <summary>Adds a combobox control to the dialog</summary>
        public ComboBox AddComboBox(int id, int x, int y, int w, int h) { return this.AddComboBox(id, x, y, w, h, 0, false); }
        ...
        /// <summary>Adds a slider control to the dialog</summary>
        public Slider AddSlider(int id, int x, int y, int w, int h) { return this.AddSlider(id, x, y, w, h, 0,100,50, false); }
        ...
        /// <summary>Adds a listbox control to the dialog</summary>
        public ListBox AddListBox(int id, int x, int y, int w, int h) { return this.AddListBox(id, x, y, w, h, ListBoxStyle.SingleSelection); }
        ...
        /// <summary>Adds an edit box control to the dialog</summary>
        public EditBox AddEditBox(int id, string text, int x, int y, int w, int h){return this.AddEditBox(id, text, x, y, w, h, false); }
        #endregion

        /// <summary>Render the dialog</summary>
        private void UpdateVertices()
        {
            this.vertices = new Microsoft.DirectX.Direct3D.CustomVertex.TransformedColoredTextured[] {
                                                                                                    new CustomVertex.TransformedColoredTextured(this.dialogX,this.dialogY,0.5f,1.0f,this.topLeftColor.ToArgb(),0.0f,0.5f),
                                                                                                    new CustomVertex.TransformedColoredTextured(this.dialogX + this.width,this.dialogY,0.5f,1.0f,this.topRightColor.ToArgb(),1.0f,0.5f),
                                                                                                    new CustomVertex.TransformedColoredTextured(this.dialogX+this.width,this.dialogY+this.height,0.5f,1.0f,this.bottomRightColor.ToArgb(),1.0f,1.0f),
                                                                                                    new CustomVertex.TransformedColoredTextured(this.dialogX,this.dialogY+this.height,0.5f,1.0f,this.bottomLeftColor.ToArgb(),0.0f,1.0f)
                                                                                                };
        }
        ...
        public void OnRender(float elapsedTime)
        {
            ...
            if (this.timeLastRefresh < timeRefresh)
            {
                this.timeLastRefresh = FrameworkTimer.GetTime();
                this.Refresh();
            }
            ...
            if (!this.isDialogMinimized)
            {
                ...
                device.DrawUserPrimitives(PrimitiveType.TriangleFan, 2, this.vertices);
            }
            ...
            TextureNode tNode = this.GetTexture(0);
            ...
            if (this.hasCaption)
            {
                ...
                System.Drawing.Rectangle rect = new System.Drawing.Rectangle(0,-this.captionHeight,this.width,0);
                this.DrawSprite(this.captionElement, rect);
                rect.Offset(5, 0); // Make a left margin
                string output = this.caption + ((this.isDialogMinimized) ? " (Minimized)" : null);
                this.DrawText(output, this.captionElement, rect, true);
            }
            ...
            if (!this.isDialogMinimized)
            {
                for(int i = 0; i < this.controlList.Count; i++)
                {
                    ...
                    if (this.controlList[i] == controlFocus)
                        continue;

                    (this.controlList[i] as Control).Render(device, elapsedTime);
                }
        ...
        public void DrawSprite(Element element, System.Drawing.Rectangle rect)
        {
            ...
            // Get the texture
            TextureNode tNode = this.GetTexture(element.TextureIndex);
        ...
        public void DrawRectangle(System.Drawing.Rectangle rect, ColorValue color)
        {
            ...
            rect.Offset(this.dialogX, this.dialogY);
            ...
            // Get the device
            Device device = this.SampleFramework.Device;
